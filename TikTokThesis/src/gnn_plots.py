...
plt.title("Train vs Test Accuracy per Epoch (GNN)", fontsize=14)
plt.xlabel("Epoch")
plt.ylabel("Accuracy")
plt.legend()
...
plt.title("Train-Test Accuracy Difference (Gap) (GNN)", fontsize=14)
plt.xlabel("Epoch")
...
plt.title("Train vs Test Loss per Epoch (GNN)", fontsize=14)
plt.xlabel("Epoch")
